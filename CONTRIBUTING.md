...
This is a **type-C fork** of [`https://gitlab.redox-os.org/redox-os/bootloader.git`](https://gitlab.redox-os.org/redox-os/bootloader.git). Read [`CLAUDE.md`](CLAUDE.md) first — the
...
- The branch E-OS builds is **`eos-rebased`**.
