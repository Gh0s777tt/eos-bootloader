...
Fork [`https://gitlab.redox-os.org/redox-os/bootloader.git`](https://gitlab.redox-os.org/redox-os/bootloader.git) niosący zmiany E-OS. Gałąź, którą buduje E-OS, to **`eos-rebased`**,
